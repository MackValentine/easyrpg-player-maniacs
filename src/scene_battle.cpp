...
void Scene_Battle::CreateUi() {
	...
	options_window->SetY(Player::Screen_Height - 80);

	help_window.reset(new Window_Help(0, 0, Player::Screen_Width, 32));
	help_window->SetVisible(false);

	item_window.reset(new Window_Item(0, (Player::Screen_Height -80), Player::Screen_Width, 80));
	item_window->SetHelpWindow(help_window.get());
	item_window->Refresh();
	item_window->SetIndex(0);

	skill_window.reset(new Window_BattleSkill(0, (Player::Screen_Height -80), Player::Screen_Width, 80));
	skill_window->SetHelpWindow(help_window.get());

	message_window.reset(new Window_Message(0, (Player::Screen_Height - 80), Player::Screen_Width, 80));
	Game_Message::SetWindow(message_window.get());
}
