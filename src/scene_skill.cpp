...
void Scene_Skill::Start() {
	...
	skillstatus_window.reset(new Window_SkillStatus(0, 32, Player::Screen_Width, 32));
	skill_window.reset(new Window_Skill(0, 64, Player::Screen_Width, Player::Screen_Height - 64));
