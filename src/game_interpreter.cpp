...
bool Game_Interpreter::CommandComment(const lcf::rpg::EventCommand &com) {
	if (Player::IsPatchDynRpg()) {
		...
		else if (s.rfind("@btl_CommandActive(", 0) == 0) {
			btl_CommandActive(s);
		}
		else if (s.rfind("@btl_GetCommandIndex(", 0) == 0) {
			btl_GetCommandIndex(s);
		}
		else if (s.rfind("@btl_SetCommandIndex", 0) == 0) {
			btl_SetCommandIndex(s);
		}
		else if (s.rfind("@btl_GetCommandMax(", 0) == 0) {
			btl_GetCommandMax(s);
		}
		else if (s.rfind("@btl_GetCommandID(", 0) == 0) {
			btl_GetCommandID(s);
		}
		else if (s.rfind("@btl_HideCommands(", 0) == 0) {
			btl_HideCommand();
		}
		else if (s.rfind("@btl_HideStatusAllies(", 0) == 0) {
			btl_HideStatusAllies();
		}
		else if (s.rfind("@btl_GetOptionX(", 0) == 0) {
			btl_getOptionX(s);
		}
		else if (s.rfind("@btl_GetActiveAlly(", 0) == 0) {
			btl_GetActiveAlly(s);
		}
		else if (s.rfind("@btl_ShowCursorAlly(", 0) == 0) {
			btl_ShowCursorAlly(s);
		}
		else if (s.rfind("@play_MoveSE(", 0) == 0) {
			btl_Play_Move_SE();
		}
		else if (s.rfind("@btl_ShowActionName(", 0) == 0) {
			btl_ShowActionName(s);
		}
		else if (s.rfind("@btl_AutoSelectActor(", 0) == 0) {
			btl_AutoSelectActor(s);
		}
		else if (s.rfind("@btl_SkillsActive(", 0) == 0) {
			btl_SkillActive(s);
		}
		else if (s.rfind("@btl_ChangeSkillWindow(", 0) == 0) {
			btl_ChangeSkillWindow(s);
		}
		else if (s.rfind("@btl_ChangeItemWindow(", 0) == 0) {
			btl_ChangeItemWindow(s);
		}
		else if (s.rfind("@btl_TargetActive(", 0) == 0) {
			btl_TargetActive(s);
		}
		else if (s.rfind("@btl_TargetAll(", 0) == 0) {
			btl_TargetAll(s);
		}
		...
		else if (s.rfind("@getUpperID(", 0) == 0) {
			getUpperID(s);
		}
		else if (s.rfind("@btl_WaitATB(", 0) == 0) {
			btl_waitATB(s);
		}
		else if (s.rfind("@btl_scaleEnemies(", 0) == 0) {
			btl_scaleEnemies(s);
		}
		else if (s.rfind("@btl_getLastCommand(", 0) == 0) {
			btl_getLastCommand(s);
		}
		else if (s.rfind("@btl_forceEscapeEnemy(", 0) == 0) {
			btl_forceEscapeEnemy(s);
		}
		else if (s.rfind("@btl_ChangeActorClass(", 0) == 0) {
			btl_ChangeActorClass(s);
		}
		else if (s.rfind("@set_Seed(", 0) == 0) {
			set_Seed(s);
		}
		else if (s.rfind("@set_MaxPartyBattle(", 0) == 0) {
			set_MaxPartyBattle(s);
		}
		else if (s.rfind("@set_MaxParty(", 0) == 0) {
			set_MaxParty(s);
		}
		else if (s.rfind("@ReplaceNameActorByClass(", 0) == 0) {
			ReplaceNameActorByClass(s);
		}
		else if (s.rfind("@OpenFormationMenu(", 0) == 0) {
			OpenFormationMenu();
		}
		else if (s.rfind("@btl_ChangeCommandWindow(", 0) == 0) {
			btl_ChangeCommandWindow(s);
		}
		else if (s.rfind("@SetOrderBack(", 0) == 0) {
			SetOrderBack(s);
		}
		else if (s.rfind("@setWindowSkill(", 0) == 0) {
			setWindowSkill(s);
		}
		else if (s.rfind("@SkillWindowUpdate(", 0) == 0) {
			SkillWindowUpdate(s);
		}
		else if (s.rfind("@SkillWindowItem(", 0) == 0) {
			SkillWindowItem(s);
		}
		else if (s.rfind("@getSkillNbr(", 0) == 0) {
			getSkillNbr(s);
		}
		else if (s.rfind("@btl_actionFinish?(", 0) == 0) {
			btl_actionFinish(s);
		}
		else if (s.rfind("@getActorClassID(", 0) == 0) {
			getActorClassID(s);
		}
		else if (s.rfind("@btl_getCommandID(", 0) == 0) {
		...
		else if (s.rfind("@btl_hidePlayer(", 0) == 0) {
			btl_hidePlayer(s);
		}
		else if (s.rfind("@disableCommand(", 0) == 0) {
			disableCommand(s);
		}
		else if (s.rfind("@openMenuWithShift(", 0) == 0) {
			openMenuWithShift(s);
		}
		else if (s.rfind("@setList(", 0) == 0) {
			setList(s);
		}
		else if (s.rfind("@printList(", 0) == 0) {
			printList(s);
		}
		else if (s.rfind("@getEltList(", 0) == 0) {
			getEltList(s);
		}
		else if (s.rfind("@popList(", 0) == 0) {
			popList(s);
		}
		else if (s.rfind("@randomPopList(", 0) == 0) {
			randomPopList(s);
		}
		else if (s.rfind("@deleteAtList(", 0) == 0) {
			deleteAtList(s);
		}
		else if (s.rfind("@clearList(", 0) == 0) {
			clearList(s);
		}
		...
		else if (s.rfind("@btl_skipWeakness(", 0) == 0) {
			btl_skipWeakness(s);
		}
		else if (s.rfind("@btl_ActorHasState(", 0) == 0) {
			btl_ActorHasState(s);
		}
		else if (s.rfind("@btl_EnemyHasState(", 0) == 0) {
			btl_EnemyHasState(s);
		}
		else if (s.rfind("@btl_EnemySetState(", 0) == 0) {
			btl_EnemySetState(s);
		}
		else if (s.rfind("@containsList(", 0) == 0) {
			containsList(s);
		}
		...
		else if (s.rfind("@btl_updateEventWhileAnimation(", 0) == 0) {
			btl_updateEventWhileAnimation(s);
		}
		else if (s.rfind("@btl_MoveActor(", 0) == 0) {
			btl_MoveActor(s);
		}
		else if (s.rfind("@btl_ResetActorPos(", 0) == 0) {
			btl_ResetActorPos(s);
		}
		else if (s.rfind("@btl_hideActor(", 0) == 0) {
			btl_hideActor(s);
		}
...
void Game_Interpreter::btl_GetSizeEnemy(std::string param) {
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				varIDW = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				varIDW = std::stoi(s);
			}
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				varIDH = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				varIDH = std::stoi(s);
			}
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		auto enemy = Main_Data::game_enemyparty->GetEnemy(enemyIndex);

		if (enemy) {

			w = enemy->GetBattleSprite()->GetWidth();
			h = enemy->GetBattleSprite()->GetHeight();

		}
		else {
			Output::Warning("Enemy ID {} doesn't exist", enemyIndex);
		}

	}

	Main_Data::game_variables->Set(varIDW, w);
	Main_Data::game_variables->Set(varIDH, h);

}

void Game_Interpreter::btl_hideActor(std::string param) {
	param.replace(0, 15, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				timer = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				timer = std::stoi(s);
			}
	...
	if (scene) {
		...
		if (actor) {
			...
			actor->GetBattleSprite()->Hide(timer);

		}
		else {
			Output::Warning("Actor ID {} doesn't exist", actorID);
		}
...
void Game_Interpreter::btl_ResetActorPos(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (scene) {
		...
		if (actor) {
			...
			Point p = Game_Battle::Calculate2k3BattlePosition(*actor);
...
void Game_Interpreter::btl_MoveActor(std::string param) {
	param.replace(0, 15, "");
	param.replace(param.end() - 1, param.end(), "");
...
void Game_Interpreter::btl_updateEventWhileAnimation(std::string param) {
	param.replace(0, 31, "");
	param.replace(param.end() - 1, param.end(), "");
	bool b = false;
	...
	ManiacsBattle::SetUpdateEventWhileAnimation(b);
}

void Game_Interpreter::SelectableWindowEnabled(std::string param) {
	param.replace(0, 26, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		if (i == 0)
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				windowID = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				windowID = std::stoi(s);
			}
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				commandID = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				commandID = std::stoi(s);
			}
		else if (i == 2)
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
	...
	bool b = false;
	auto& pic = Main_Data::game_pictures->GetPicture(windowID);
	if (&pic != NULL) {
		auto window = pic.getWindow();

		Window_Command* w = dynamic_cast<Window_Command*> (window);
		if (w) {
			b = w->Enabled(commandID);
		}
...
void Game_Interpreter::deleteEltList(std::string param) {
	param.replace(0, 15, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (listID < Main_Data::game_lists->GetSize()) {
		Main_Data::game_lists->DeleteElt(listID, elt);

	}

}

void Game_Interpreter::containsList(std::string param) {
	param.replace(0, 14, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (listID < Main_Data::game_lists->GetSize()) {
		...
		b = Main_Data::game_lists->Contains(listID, elt);
...
void Game_Interpreter::btl_EnemySetState(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		...
		else if (i == 1)
		{
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				stateID = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				stateID = std::stoi(s);
			}
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		Output::Debug("State ID {} Added", stateID);
		Main_Data::game_enemyparty->GetEnemies()[enemyID]->AddState(stateID, true);
	}
...
void Game_Interpreter::btl_EnemyHasState(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		auto enemy = Main_Data::game_enemyparty->GetEnemy(enemyID);

		if (Main_Data::game_enemyparty->GetEnemy(enemyID)->HasState(stateID)) {
			result = true;
		}
	}
...
void Game_Interpreter::btl_ActorHasState(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	bool result = false;
	if (Main_Data::game_actors->GetActor(actorID)->HasState(stateID)) {
		result = true;
	}
...
void Game_Interpreter::btl_skipWeakness(std::string param) {
	param.replace(0, 18, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = 0;
	...
	if (param.rfind("v[", 0) == 0) {
		param.replace(0, 2, "");
		param.replace(param.end() - 1, param.end(), "");
		id = Main_Data::game_variables->Get(std::stoi(param));
	}
	else {
		id = std::stoi(param);
	}

	ManiacsBattle::Add_SkipWeakness(id);
}

void Game_Interpreter::btl_hideState(std::string param) {
	param.replace(0, 15, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = 0;
	...
	ManiacsBattle::Add_HidedStates(id);
}


void Game_Interpreter::sizeList(std::string param) {
	param.replace(0, 10, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (listID < Main_Data::game_lists->GetSize()) {
		...
		value = Main_Data::game_lists->GetSizeList(listID);
...
void Game_Interpreter::clearList(std::string param) {
	param.replace(0, 11, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = 0;
	...
	if (id < Main_Data::game_lists->GetSize()) {
		Main_Data::game_lists->Clear(id);
	}
}

void Game_Interpreter::deleteAtList(std::string param) {
	param.replace(0, 14, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (listID < Main_Data::game_lists->GetSize()) {
		...
		Main_Data::game_lists->Delete(listID, elementID);

	}

}

void Game_Interpreter::randomPopList(std::string param) {
	param.replace(0, 15, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (listID < Main_Data::game_lists->GetSize()) {
		...
		value = Main_Data::game_lists->randomPop(listID);
...
void Game_Interpreter::popList(std::string param) {
	param.replace(0, 9, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (listID < Main_Data::game_lists->GetSize()) {
		...
		value = Main_Data::game_lists->Pop(listID);
...
void Game_Interpreter::getEltList(std::string param) {
	param.replace(0, 12, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		...
		else if (i == 2)
		{
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				eltID = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				eltID = std::stoi(s);
			}
	...
	//Output::Debug("L{} E{}", listID, eltID);

	int value = 0;
	if (listID < Main_Data::game_lists->GetSize()) {

		value = Main_Data::game_lists->GetElt(listID, eltID);
...
void Game_Interpreter::printList(std::string param) {
	param.replace(0, 11, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = 0;
	...
	if (id < Main_Data::game_lists->GetSize()) {
		std::vector<int> v = Main_Data::game_lists->Get(id);

		for (int i : v) {
			Output::Debug("List {} : {}", id, i);
		}
	}
}

void Game_Interpreter::setList(std::string param) {
	param.replace(0, 9, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (varID < Main_Data::game_lists->GetSize()) {
		Main_Data::game_lists->Set(varID, v);
	}

}

void Game_Interpreter::openMenuWithShift(std::string param) {

	Main_Data::game_player->shift4Menu = true;

}

void Game_Interpreter::disableCommand(std::string param) {
	param.replace(0, 16, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (&pic != NULL) {
		...
		Window_Command* w = dynamic_cast<Window_Command*> (window);
		if (w)
			w->DisableItem(commandID);
		
	}

}

void Game_Interpreter::btl_hidePlayer(std::string param) {
	param.replace(0, 16, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = 0;
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		int actor_id = Main_Data::game_party->GetActorPositionInParty(0);
...
void Game_Interpreter::btl_getLastCommandID(std::string param) {
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				actor_id = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				actor_id = std::stoi(s);
			}
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		int id = scene->getLastCommand(actor_id);
		//Output::Debug("V{} A{} I{}", var_id, actor_id, id);
		Main_Data::game_variables->Set(var_id, id);
	}
...
void Game_Interpreter::getActorClassID(std::string param) {
	param.replace(0, 17, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	auto actor = Main_Data::game_actors->GetActor(actorID);
	int r = actor->GetClass()->ID;

	//Output::Debug("Class ID : {}", r);

	Main_Data::game_variables->Set(var_id, r);
}

void Game_Interpreter::btl_actionFinish(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		bool b = scene->GetBattleActionPending() == nullptr;
...
void Game_Interpreter::getSkillNbr(std::string param) {
	param.replace(0, 13, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				skill_var = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				skill_var = std::stoi(s);
			}
		i += 1;

	}

	//Output::Debug("AID{} Var{}", user_id, skill_var);

	auto actor = Main_Data::game_actors->GetActor(user_id);
	int r = actor->GetSkills().size();

	Main_Data::game_variables->Set(skill_var, r);
}

void Game_Interpreter::setWindowSkill(std::string param) {
	param.replace(0, 16, "");
	param.replace(param.end() - 1, param.end(), "");
...
void Game_Interpreter::SkillWindowItem(std::string param) {
	param.replace(0, 17, "");
	param.replace(param.end() - 1, param.end(), "");
...
void Game_Interpreter::SkillWindowUpdate(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
...
void Game_Interpreter::SetOrderBack(std::string param) {
	param.replace(0, 14, "");
	param.replace(param.end() - 1, param.end(), "");

	Main_Data::game_system->orderBackName = param;

}
void Game_Interpreter::btl_ChangeCommandWindow(std::string param) {
	param.replace(0, 25, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		if (scene->command_window) {

			//Output::Debug("X {} Y {} W {} H {}",x,y,w,h);

			scene->command_window->SetWidth(w);
			scene->command_window->SetHeight(h);
			scene->command_window->SetX(x);
			scene->command_window->SetY(y);
		}
	}
...
void Game_Interpreter::ReplaceNameActorByClass(std::string param) {
	...
	if (param.rfind("v[", 0) == 0) {
		param.replace(0, 2, "");
		param.replace(param.end() - 1, param.end(), "");
		n = Main_Data::game_variables->Get(std::stoi(param));
	}
	else {
		n = std::stoi(param);
	}
	...
	auto actor = Main_Data::game_actors->GetActor(n);
	actor->SetName(actor->GetClassName().to_string());

	int class_id = actor->GetClass()->ID;
	int i = (((class_id-1) / 16) + 1);
	std::string face_name = "Monsters" + std::to_string(i);
	int face_index = (class_id-1) % 16;
	actor->SetFace(face_name, face_index);


}
void Game_Interpreter::set_MaxPartyBattle(std::string param) {
...
void Game_Interpreter::set_MaxParty(std::string param) {
	...
	Main_Data::game_party->max_Party = n;
}

void Game_Interpreter::set_Seed(std::string param) {
	param.replace(0, 10, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (param.rfind("v[", 0) == 0) {
		param.replace(0, 2, "");
		param.replace(param.end() - 1, param.end(), "");
		seed = Main_Data::game_variables->Get(std::stoi(param));
	}
	else {
		seed = std::stoi(param);
	}
...
void Game_Interpreter::btl_forceEscapeEnemy(std::string param) {
	param.replace(0, 22, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		scene->forceEscapeEnemy(id);
	}
}

void Game_Interpreter::btl_ChangeActorClass(std::string param) {
	param.replace(0, 22, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				class_id = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				class_id = std::stoi(s);
			}
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				level = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				level = std::stoi(s);
			}
	...
	//Output::Debug("L{} C{}", level, class_id);

	auto actor = Main_Data::game_actors->GetActor(actor_id);
	actor->ChangeClass(class_id, level,
		static_cast<Game_Actor::ClassChangeSkillMode>(1),
		static_cast<Game_Actor::ClassChangeParamMode>(3),
		nullptr
	);

}

void Game_Interpreter::btl_getLastCommand(std::string param) {
	param.replace(0, 20, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				command_id = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
	...
	//Output::Debug("S {} A {} C {}", switch_id, actor_id, command_id);
	...
	if (scene) {
		int id = scene->getLastCommand(actor_id);
	//	Output::Debug("Command : {}", id);
		if (id == command_id)
			b = true;
	}

	Main_Data::game_switches->Set(switch_id, b);

}
void Game_Interpreter::btl_scaleEnemies(std::string param) {
	param.replace(0, 18, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (param.rfind("v[", 0) == 0) {
		param.replace(0, 2, "");
		param.replace(param.end() - 1, param.end(), "");
		level = Main_Data::game_variables->Get(std::stoi(param));
	}
	else {
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		scene->scaleEnemies(level);
	}
}

void Game_Interpreter::btl_waitATB(std::string param) {
	param.replace(0, 13, "");
	param.replace(param.end() - 1, param.end(), "");
	bool b = false;
	if (param == "true")
	...
	if (b)
		Main_Data::game_system->SetAtbMode(lcf::rpg::SaveSystem::AtbMode_atb_wait);
	else
		Main_Data::game_system->SetAtbMode(lcf::rpg::SaveSystem::AtbMode_atb_active);
}

void Game_Interpreter::getUpperID(std::string param) {
	param.replace(0, 12, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	int r = scene->spriteset->getTile(x, y) - 10000;

	Main_Data::game_variables->Set(id, r);
	//Output::Debug("{} {} {} {}", id, r, x, y);
...
void Game_Interpreter::btl_LastAction(std::string param) {
	...
	if (scene) {
		int t = 0;
		if (scene->getPreviousState() == Scene_Battle::State::State_SelectCommand)
			t = 0;
		else if (scene->getPreviousState() == Scene_Battle::State::State_SelectItem)
			t = 1;
		else if (scene->getPreviousState() == Scene_Battle::State::State_SelectSkill)
			t = 2;
		else if (scene->getPreviousState() == Scene_Battle::State::State_SelectEnemyTarget)
			t = 3;
		else if (scene->getPreviousState() == Scene_Battle::State::State_SelectAllyTarget)
			t = 4;

		Main_Data::game_variables->Set(id, t);
...
void Game_Interpreter::btl_forceAction(std::string param) {
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		if (!scene->GetBattleActionPending()) {
			...
			if (action_type == 0) {
				if (action_id == 2) {
					...
					a->SetBattleAlgorithm(std::make_shared<Game_BattleAlgorithm::Defend>(a));
				}
			}
...
void Game_Interpreter::btl_AutoSelectActor(std::string param) {
	...
	ManiacsBattle::Set_AutoSelect(b);

}

void Game_Interpreter::btl_ShowActionName(std::string param) {
	param.replace(0, 20, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	Scene_Battle_Rpg2k3* scene = (Scene_Battle_Rpg2k3*)Scene::Find(Scene::Battle).get();
	if (scene) {
		if (scene->active_actor)
		{
			auto& pic = Main_Data::game_pictures->GetPicture(id);
			if (&pic != NULL)
				if (pic.data.easyrpg_type == lcf::rpg::SavePicture::EasyRpgType_window) {

					int command_id = scene->command_window->GetIndex();
					auto commands = scene->active_actor->GetBattleCommands();
					if (command_id < commands.size()) {
						Main_Data::game_windows->GetWindow(id).data.texts[0].text = commands[command_id]->name;
						Main_Data::game_windows->GetWindow(id).Refresh();

					}
					else {
						Main_Data::game_windows->GetWindow(id).data.texts[0].text = lcf::Data::terms.row;
						Main_Data::game_windows->GetWindow(id).Refresh();
					}
...
void Game_Interpreter::btl_Play_Move_SE() {
	Main_Data::game_system->SePlay(Main_Data::game_system->GetSystemSE(Main_Data::game_system->SFX_Cursor));

}
void Game_Interpreter::btl_HideCommand() {
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		scene->command_window->SetVisible(false);
		scene->command_window->SetY(-9999);
	}

}
void Game_Interpreter::btl_HideStatusAllies() {
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		scene->status_window->SetVisible(false);
		scene->status_window->SetY(-9999);
	}

}
void Game_Interpreter::btl_ShowCursorAlly(std::string param) {
	param.replace(0, 20, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	if (scene) {
		if (scene->active_actor)
		{
			int x = scene->active_actor->GetBattlePosition().x;
			int y = scene->active_actor->GetBattlePosition().y;
			...
			if (&pic != NULL)
				if (pic.Exists()) {
					...
					params.position_x = x + 8;
					params.position_y = y - 32;
					pic.Show(params);
				}
		}
	}
...
void Game_Interpreter::btl_TargetAll(std::string param) {
	param.replace(0, 15, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	if (scene) {
		if (scene->active_actor)
		{
			std::vector<Game_Battler*> party;
			if (scene->status_window->GetActive())
				scene->active_actor->GetParty().GetBattlers(party);
			else
				Main_Data::game_enemyparty->GetActiveBattlers(party);
			int m = party.size();
			for (int i = 0; i < m; i++) {
				...
				int index = 0;
				if (scene->status_window->GetActive()) {
					index = scene->status_window->GetIndex();
				}
				else {
					index = scene->target_window->GetIndex();
				}
				if (index != i) {
					int x = party[i]->GetBattlePosition().x;
					int y = party[i]->GetBattlePosition().y;

					auto& pic = Main_Data::game_pictures->GetPicture(id + i);
					if (&pic != NULL)
						if (pic.Exists()) {
							Game_Pictures::ShowParams params;
							params = pic.GetShowParams();
							if (scene->target_window->GetActive()) {
								...
								if (sprite) {
									params.position_x = enemy->GetBattlePosition().x + sprite->GetWidth() / 2 + 8;
									params.position_y = enemy->GetBattlePosition().y + 8;
								}
							}
							else {
								params.position_x = x + 8;
					...
					if (&pic != NULL)
						if (pic.Exists()) {
							Game_Pictures::ShowParams params;
							params = pic.GetShowParams();
							params.position_x = -9999;
							params.position_y = -9999;
							pic.Show(params);
...
void Game_Interpreter::btl_EnemyActive(std::string param) {
	param.replace(0, 17, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	if (scene) {
		if (scene->target_window) {
			bool b = scene->target_window->GetActive();
			Main_Data::game_switches->Set(id, b);
		}
	}
...
void Game_Interpreter::btl_SkillActive(std::string param) {
	...
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		if (scene->skill_window) {
			Main_Data::game_switches->Set(id, scene->skill_window->GetActive());
		}
	}

}

void Game_Interpreter::btl_ChangeItemWindow(std::string param) {
	param.replace(0, 22, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		if (scene->item_window) {
			scene->item_window.reset(new Window_Item(x, y, w, h));
			scene->item_window->SetColumn(c);
			scene->item_window->Refresh();
			scene->item_window->SetIndex(0);
		}
	}

}

void Game_Interpreter::btl_ChangeSkillWindow(std::string param) {
	param.replace(0, 23, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (scene) {
		if (scene->skill_window) {
			scene->skill_window.reset(new Window_BattleSkill(x, y ,w ,h));
			scene->skill_window->SetColumn(c);
		}
	}

}

void Game_Interpreter::btl_CommandActive(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		Main_Data::game_switches->Set(id, scene->command_window->GetActive());
	}

}
void Game_Interpreter::btl_GetCommandIndex(std::string param) {
	param.replace(0, 21, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	if (scene) {
		...
		Main_Data::game_variables->Set(id, scene->command_window->GetIndex());
	}

}
void Game_Interpreter::btl_GetCommandMax(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		Main_Data::game_variables->Set(id, scene->command_window->GetItemMax());
	}

}

void Game_Interpreter::btl_GetActiveAlly(std::string param) {
	param.replace(0, 19, "");
	param.replace(param.end() - 1, param.end(), "");

	int id = std::stoi(param);
	Main_Data::game_variables->Set(id, -1);

	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		//const auto* command = scene->active_actor->GetBattleCommand(v);
		if (scene->active_actor)
			Main_Data::game_variables->Set(id, scene->active_actor->GetId());
	}

}

void Game_Interpreter::btl_GetCommandID(std::string param) {
	param.replace(0, 18, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	for (auto& s : out) {
		if (i == 0)
			...
			if (s.rfind("v[", 0) == 0) {
				s.replace(0, 2, "");
				s.replace(s.end() - 1, s.end(), "");
				v = Main_Data::game_variables->Get(std::stoi(s));
			}
			else {
				v = std::stoi(s);
			}
	...
	std::string ss = std::to_string(id) + "/" + std::to_string(v);
	//Output::Warning(ss); 
	...
	if (scene) {
		if (scene->active_actor->GetBattleCommand(v)) {
			...
			Main_Data::game_variables->Set(id, command->ID);
		}
		else {
			Main_Data::game_variables->Set(id, 0);
		}
	}

}

void Game_Interpreter::btl_SetCommandIndex(std::string param) {
	param.replace(0, 21, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	// Output::Warning(param + "AZE"); 

	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {

		scene->command_window->SetIndex(id);
	}

}
void Game_Interpreter::show_Number(std::string param) {
	param.replace(0, 12, "");
	param.replace(0, 1, "");
	param.replace(param.end() - 1, param.end(), "");
	...
	if (system != "")
	{
		system2 = Cache::System2(system);
	}
	else
		system2 = Cache::System2();

	if (&pic != NULL && system2 != NULL)
		if (pic.Exists()) {

			BitmapRef bitmap = Bitmap::Create(4 * 8, 16, true);
			pic.sprite->SetBitmap(bitmap);

			pic.sprite->GetBitmap()->Clear();

			bool handle_zero = false;

			if (v >= 1000) {
				pic.sprite->GetBitmap()->Blit(0, 0, *system2, Rect((v / 1000) * 8, 80, 8, 16), Opacity::Opaque());
				v %= 1000;
				if (v < 100) {
					handle_zero = true;
				}
			}
			if (handle_zero || v >= 100) {
				handle_zero = false;
				pic.sprite->GetBitmap()->Blit(8, 0, *system2, Rect((v / 100) * 8, 80, 8, 16), Opacity::Opaque());
				v %= 100;
				if (v < 10) {
					handle_zero = true;
				}
			...
			if (handle_zero || v >= 10) {
				pic.sprite->GetBitmap()->Blit(8 * 2, 0, *system2, Rect((v / 10) * 8, 80, 8, 16), Opacity::Opaque());
				v %= 10;
			}

			pic.sprite->GetBitmap()->Blit(8 * 3, 0, *system2, Rect(v * 8, 80, 8, 16), Opacity::Opaque());
...
void Game_Interpreter::btl_getOptionX(std::string param) {
	param.replace(0, 16, "");
	param.replace(param.end() - 1, param.end(), "");
	int id = std::stoi(param);
	...
	Scene_Battle* scene = (Scene_Battle*)Scene::Find(Scene::Battle).get();
	if (scene) {
		Main_Data::game_variables->Set(id, scene->options_window->GetX());
	}
}

void Game_Interpreter::show_Gauge(std::string param) {
	...
	std::string ss = std::to_string(id) + "/" + std::to_string(w) + "/" + std::to_string(v);
	...
	if (&pic != NULL && system2 != NULL)
		if (pic.Exists()) {
			...
			BitmapRef bitmap = Bitmap::Create(w + 32, 16, true);
			pic.sprite->SetBitmap(bitmap);
			
			pic.sprite->GetBitmap()->Clear();

			pic.sprite->GetBitmap()->Blit(0, 0, *system2, Rect(0, 32 + type * 16, 16, 16), 255);
			pic.sprite->GetBitmap()->StretchBlit(Rect(16, 0, w, 16), *system2, Rect(16, 32 + type * 16, 16, 16), Opacity::Opaque());
			pic.sprite->GetBitmap()->Blit(16 + w, 0, *system2, Rect(32, 32 + type * 16, 16, 16), 255);

			int gauge_width = w * v / 100;

			pic.sprite->GetBitmap()->StretchBlit(Rect(16, 0, gauge_width, 16), *system2, Rect(48 + gauge_x, 32 + 16 * type, 16, 16), Opacity::Opaque());
		...
		if (Player::IsPatchManiac()) {
			switch (com.parameters[1]) {
				case 0:
					...
					result = Main_Data::game_system->justLoaded;
					break;
				case 1:
...
bool Game_Interpreter::CommandManiacLoad(lcf::rpg::EventCommand const& com) {
	...
	Scene::instance->SetRequestedScene(std::make_shared<Scene_Load>(slot));
	++index;
	return true;
}
