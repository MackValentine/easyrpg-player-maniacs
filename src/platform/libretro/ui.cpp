...
RETRO_API void retro_get_system_av_info(struct retro_system_av_info* info) {
	info->geometry.base_width = Player::Screen_Width;
	info->geometry.base_height = Player::Screen_Height;
	info->geometry.max_width = Player::Screen_Width;
	info->geometry.max_height = Player::Screen_Height;
