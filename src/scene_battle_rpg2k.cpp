...
void Scene_Battle_Rpg2k::CreateUi() {
	...
	status_window.reset(new Window_BattleStatus(0, (Player::Screen_Height -80), Player::Screen_Width - option_command_mov, 80));

	CreateBattleTargetWindow();
	CreateBattleCommandWindow();

	battle_message_window.reset(new Window_BattleMessage(0, (Player::Screen_Height - 80), Player::Screen_Width, 80));
...
void Scene_Battle_Rpg2k::CreateBattleCommandWindow() {
	...
	command_window->SetX(Player::Screen_Width - option_command_mov);
