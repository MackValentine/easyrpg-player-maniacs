...
void Scene_GameBrowser::CreateWindows() {
	...
	gamelist_window = std::make_unique<Window_GameList>(60, 32, Player::Screen_Width - 60, Player::Screen_Height - 32);
	...
	about_window = std::make_unique<Window_About>(60, 32, Player::Screen_Width - 60, Player::Screen_Height - 32);
